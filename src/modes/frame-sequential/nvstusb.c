...
nvstusb_init(char const * fw)
{
  ...
  /* Swap interval */
  glXSwapIntervalSGI = (PFNGLXSWAPINTERVALSGIPROC)glXGetProcAddress((unsigned char *)"glXSwapIntervalSGI");
  ...
  /* Sync Video */
  glXGetVideoSyncSGI = (PFNGLXGETVIDEOSYNCSGIPROC)glXGetProcAddress((unsigned char *)"glXGetVideoSyncSGI");
  glXWaitVideoSyncSGI = (PFNGLXWAITVIDEOSYNCSGIPROC)glXGetProcAddress((unsigned char *)"glXWaitVideoSyncSGI");
